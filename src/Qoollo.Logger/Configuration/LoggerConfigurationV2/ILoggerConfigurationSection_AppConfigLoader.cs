...
namespace Qoollo.Logger.Configuration
{
    ...
    */
    ...
    public static class LoggerConfigurationSectionAppConfigLoader
    {
        public const string DefaultSectionName = "LoggerConfigurationSectionSection";
    
        public static ILoggerConfigurationSection Load(string sectionGroupName, string sectionName)
        {
            string fullSectionName = sectionName;
            if (sectionGroupName != null)
                fullSectionName = sectionGroupName + "/" + sectionName;
    
            var cfg = (LoggerConfigurationSectionConfigClass)ConfigurationManager.GetSection(fullSectionName);
            return cfg.ExtractConfigData();
        }
        public static ILoggerConfigurationSection Load(string sectionName)
        {
            return Load(null, sectionName);
        }
        public static ILoggerConfigurationSection Load()
        {
    ...
    */
    ...
    internal class AsyncReliableQueueWrapperImplement : IAsyncReliableQueueWrapper
    {
        public AsyncReliableQueueWrapperImplement()
        {
            this._maxQueueSize = 4096;
            this._isDiscardExcess = true;
            this._folderForTemporaryStore = Qoollo.Logger.Configuration.AsyncReliableQueueWrapperConfiguration.DefaultFolderName;
    ...
    internal class ConsoleWriterImplement : IConsoleWriter
    {
        ...
        {
            this._template = Qoollo.Logger.Configuration.ConsoleWriterConfiguration.DefaultTemplateFormat;
    ...
    internal class DatabaseWriterImplement : IDatabaseWriter
    {
        ...
        {
            this._storedProcedureName = Qoollo.Logger.Configuration.DatabaseWriterConfiguration.DefaultStoredProcedureName;
            this._logLevel = CfgLogLevel.TRACE;
        }
    ...
    internal class FileWriterImplement : IFileWriter
    {
        ...
        {
            this._template = Qoollo.Logger.Configuration.FileWriterConfiguration.DefaultTemplateFormat;
            this._fileNameTemplate = Qoollo.Logger.Configuration.FileWriterConfiguration.DefaultFileNameTemplateFormat;
    ...
    internal class LoggerWriterWrapperConfigurationImplement : ILoggerWriterWrapperConfiguration
    {
        ...
        public static ILoggerWriterWrapperConfiguration CopyInh(ILoggerWriterWrapperConfiguration src)
        {
        	...
        	if (src.GetType() == typeof(GroupWrapperImplement))
        		return ((GroupWrapperImplement)src).Copy();
        	if (src.GetType() == typeof(LogstashWriterImplement))
        		return ((LogstashWriterImplement)src).Copy();
    ...
    internal class LogstashWriterImplement : ILogstashWriter
    {
        public LogstashWriterImplement()
        {
            this._port = Qoollo.Logger.Configuration.LogstashWriterConfiguration.DefaultPort;
            this._logLevel = CfgLogLevel.TRACE;
        }
        ...
        String ILogstashWriter.ServerAddress
        {
        ...
        public LogstashWriterImplement Copy()
        {
        	var res = new LogstashWriterImplement();
        ...
        public static ILogstashWriter CopyInh(ILogstashWriter src)
        {
        	if (src == null)
        		return null;
    ...
    internal class NetworkWriterImplement : INetworkWriter
    {
        ...
        {
            this._port = Qoollo.Logger.Configuration.NetWriterConfiguration.DefaultPort;
            this._logLevel = CfgLogLevel.TRACE;
        }
    ...
    internal class PipeWriterImplement : IPipeWriter
    {
        ...
        {
            this._serverName = Qoollo.Logger.Configuration.PipeWriterConfiguration.DefaultServerName;
            this._pipeName = Qoollo.Logger.Configuration.PipeWriterConfiguration.DefaultPipeName;
            this._logLevel = CfgLogLevel.TRACE;
        }
    ...
    internal class LoggerConfigurationSectionConfigClass : System.Configuration.ConfigurationSection
    {
        ...
        {
    		return (T)System.ComponentModel.TypeDescriptor.GetConverter(typeof(T)).ConvertFromString(null, System.Globalization.CultureInfo.InvariantCulture, value);
        }
        ...
        private ILoggerWriterWrapperConfiguration DeserializeILoggerWriterWrapperConfigurationElemWithInh(System.Xml.XmlReader reader)
        {
        	...
        	switch (reader.Name)
        	{
                ...
                case "groupWrapper":
                    return DeserializeIGroupWrapperElem(reader);
                case "logstashWriter":
                    return DeserializeILogstashWriterElem(reader);
                case "networkWriter":
        ...
        private ILogstashWriter DeserializeILogstashWriterElem(System.Xml.XmlReader reader)
        {
        	var res = new LogstashWriterImplement();
            ...
            if (attribGenTempVal != null)
                ...
                throw new System.Configuration.ConfigurationErrorsException("Attribute 'serverAddress for element 'ILogstashWriter' not defined", reader);

            attribGenTempVal = reader.GetAttribute("port");
            if (attribGenTempVal != null)
                res.SetPortVal(Parse<Int32>(attribGenTempVal));
            else
                throw new System.Configuration.ConfigurationErrorsException("Attribute 'port for element 'ILogstashWriter' not defined", reader);
            		...
            		{			
                        switch (reader.Name)
                        {
                            case "add":
                                string addKey = reader.GetAttribute("key");
                                if (addKey == null)
                                	throw new System.Configuration.ConfigurationErrorsException("Key not found for 'add' inside element 'ILogstashWriter'", reader);	
                                
                                switch (addKey)
                                {
                                	default:
                                		throw new System.Configuration.ConfigurationErrorsException("Unknown key " + addKey + " inside element 'ILogstashWriter'", reader);
                                }
                            default:
                                throw new System.Configuration.ConfigurationErrorsException("Unknown element inside 'ILogstashWriter': " + reader.Name, reader);
                        }
            		}
            	}
            	while (reader.NodeType != System.Xml.XmlNodeType.EndElement || reader.Name != initialName);
        ...
        private ILogstashWriter DeserializeILogstashWriterElem(System.Xml.XmlReader reader, string expectedName)
        {
        	if (reader.NodeType != System.Xml.XmlNodeType.Element)
        		throw new System.Configuration.ConfigurationErrorsException("Expected Element node type", reader);
        
        	if (expectedName != null && reader.Name != expectedName)
        		throw new System.Configuration.ConfigurationErrorsException("Unexpected element name for type 'ILogstashWriter': " + reader.Name, reader);
            
        	return DeserializeILogstashWriterElem(reader);
        }

        private ILogstashWriter DeserializeILogstashWriterElemWithInh(System.Xml.XmlReader reader)
        {
        	if (reader.NodeType != System.Xml.XmlNodeType.Element)
        		throw new System.Configuration.ConfigurationErrorsException("Not an Element node type", reader);
        	...
        	switch (reader.Name)
        	{
                case "logstashWriter":
                    return DeserializeILogstashWriterElem(reader);
                default:
                    throw new System.Configuration.ConfigurationErrorsException("Unknown child type name: '" + reader.Name + "' for base type 'ILogstashWriter'", reader);
            }
        }
