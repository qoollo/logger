...
namespace Qoollo.Logger.Configuration
{
    ...
    */
    ...
    public class LoggerConfigurationSectionImplement : ILoggerConfigurationSection
    {
    ...
    public class RootLoggerConfigurationImplement : IRootLoggerConfiguration
    {
    ...
    public class LoggerWriterWrapperConfigurationImplement : ILoggerWriterWrapperConfiguration
    {
    ...
    public class GroupWrapperImplement : IGroupWrapper
    {
    ...
    public class ReliableWrapperImplement : IReliableWrapper
    {
    ...
    public class PipeWriterImplement : IPipeWriter
    {
        public PipeWriterImplement()
        {
            this._serverName = ".";
            this._pipeName = "LoggingService";
    ...
    public class AsyncReliableQueueWrapperImplement : IAsyncReliableQueueWrapper
    {
        public AsyncReliableQueueWrapperImplement()
        {
            this._maxQueueSize = 4096;
            this._isDiscardExcess = true;
            this._folderForTemporaryStore = "reliable_log_q";
            this._maxFileSize = 67108864;
            this._logger = new LoggerWriterWrapperConfigurationImplement();
        }
    ...
    public class PatternMatchingWrapperImplement : IPatternMatchingWrapper
    {
    ...
    public class PatternMatchingElementImplement : IPatternMatchingElement
    {
    ...
    public class EmptyWriterImplement : IEmptyWriter
    {
    ...
    public class ConsoleWriterImplement : IConsoleWriter
    {
        public ConsoleWriterImplement()
        {
            this._template = "{DateTime}. {Level}. At {StackSource}.{Class}::{Method}. Message: {Message}. {Exception, prefix = ' Exception: ', valueOnNull=''}";
            this._logLevel = CfgLogLevel.TRACE;
        }
    ...
    public class FileWriterImplement : IFileWriter
    {
        public FileWriterImplement()
        {
            this._template = "{DateTime}. {Level}. At {StackSource}.{Class}::{Method}. Message: {Message}. {Exception, prefix = ' Exception: ', valueOnNull=''}";
            this._fileNameTemplate = "logs/app.log";
    ...
    public class RoutingWrapperImplement : IRoutingWrapper
    {
    ...
    public class NetworkWriterImplement : INetworkWriter
    {
    ...
    public class DatabaseWriterImplement : IDatabaseWriter
    {
        public DatabaseWriterImplement()
        {
            this._storedProcedureName = "[dbo].[LogInsert]";
            this._logLevel = CfgLogLevel.TRACE;
        }
    ...
    public class AsyncQueueWrapperImplement : IAsyncQueueWrapper
    {
    ...
    public class CustomWriterImplement : ICustomWriter
    {
    ...
    public class PatternMatchingDefaultImplement : IPatternMatchingDefault
    {
    ...
    public class PatternMatchingMatchImplement : IPatternMatchingMatch
    {
    ...
    public class LoggerConfigurationSectionConfigClass : System.Configuration.ConfigurationSection
    {
